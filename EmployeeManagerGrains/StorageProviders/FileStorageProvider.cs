...
namespace StorageProviders
{
    public class FileStorageProvider : IStorageProvider
    {
                      ...
                      Orleans.Providers.IProviderConfiguration config)
        {
            ...
            _jsonSettings = OrleansJsonSerializer.UpdateSerializerSettings(OrleansJsonSerializer.GetDefaultSerializerSettings(_serializationManager, providerRuntime.GrainFactory), config);
